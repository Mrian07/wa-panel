...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            <div class="logo">
                <a style="background: url(<?= _assets('images/velixs.png') ?>) no-repeat; height: 60px" href="#">WA
                    EGDEV</a>
            </div>
            ...
            <form method="post">
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="text" name="username" class="form-control m-b-md" id="signInEmail"
                        aria-describedby="signInEmail" placeholder="Enter Username">
