                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                            data-bs-target="#tab_input" type="button" role="tab" aria-controls="home"
                                            aria-selected="true">Input</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                            data-bs-target="#tab_datatable" type="button" role="tab"
                                            aria-controls="profile" aria-selected="false">Datatable</button>
                                    </li>
                                </ul>
                                <br>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="tab_input" role="tabpanel"
                                        ...
                                        <form action="" method="post" class="loadingbtn">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-xl-6">
                                                    <div class="mt-3">
                                                        ...
                                                        <div id="input_tujuan">
                                                            <select class="js-states form-control" name="listnumber[]"
                                                                id="listnumber" tabindex="-1"
                                                                ...
                                                                <optgroup label="Nomor">
                                                                    ...
                                                                    <option value="<?= $n->nomor ?>">
                                                                        <?= "$n->nomor ($n->nama)" ?></option>
                                                                    <?php endforeach ?>
                                                                </optgroup>
                                                            </select>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" id="allcheck"
                                                                type="checkbox" name="all_number">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" id="inputmedia" name="media"
                                                                class="form-control" placeholder="Link media">
                                                            <span onclick="mediamodal()" class="btn btn-primary"><span
                                                                    class="material-icons pt-1">file_upload</span></span>
                                                        </div>
                                                ...
                                                <div class="col-12 col-xl-6">
                                                    <div class="mt-3">
                                                        ...
                                                        <textarea name="pesan" class="form-control" rows="7"
                                                            placeholder="Contoh : Hai {name}" required></textarea>
                                                        <small>note : {name} menulis nama sesuai penerima. <br> Ketika
                                                            kamu kirim file pdf input pesan akan di gunakan untuk nama
                                                            file pdf.</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-end btnkirim mt-3">
                                                <button type="submit" class="btn btn-primary"><i
                                                        class="material-icons">send</i>Kirim</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="tab-pane fade" id="tab_datatable" role="tabpanel"
                                        ...
                                        <form action="<?= base_url("blast/del") ?>" method="post">
                                            ...
                                            <table id="datatable1" class="display" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th><input class="form-check-input" onchange="checkAll(this)"
                                                                name="chk[]" type="checkbox"></th>
                                                        <th>Sender</th>
                                                        <th>To</th>
                                                        <th>Pesan</th>
                                                        <th>Media</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><input class="form-check-input checkdel" name="id[]"
                                                                value="<?= $b->id ?>" type="checkbox"></td>
                                                        <td><?= $b->sender ?></td>
                                                        <td><?= $b->tujuan ?></td>
                                                        <td><?= $b->pesan ?></td>
                                                        <td><?= ($b->media == '') ? '<button class="btn btn-secondary btn-sm" disabled>None</button>' : '<button type="button" class="btn btn-primary btn-sm" onclick="lihat_gambar(`' . $b->media . '`)">Lihat</button>' ?>
                                                        </td>
                                                        <td>
                                                            <?php
                                                                if ($b->status == 'pending') {
