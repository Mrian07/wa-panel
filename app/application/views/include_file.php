<script>
    ...
    function uploadmedia() {
        $("#getmedia").html('<div class="alert alert-primary alert-style-light text-center" role="alert"><div class="spinner-grow" style="height: 20px; width: 20px;" role="status"><span class="visually-hidden">Loading...</span></div>Mengunggah Media..</div>');
    ...
    $(".loadingbtn").submit(function() {
        $(".btnkirim").html('<button class="btn btn-primary" type="button" disabled><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>Mengirim...</button>')
    })
</script>
