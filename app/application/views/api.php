                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                            data-bs-target="#p-text" type="button" role="tab" aria-controls=""
                                            aria-selected=" true">Pesan Text</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                            data-bs-target="#p-media" type="button" role="tab" aria-controls=""
                                            aria-selected="false">Pesan Media</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                            data-bs-target="#p-tombol" type="button" role="tab" aria-controls=""
                                            aria-selected="false">Pesan Button</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                            data-bs-target="#webhooksss" type="button" role="tab" aria-controls=""
                                            aria-selected="false">Webhook</button>
                                    </li>
                                </ul>

                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="p-text" role="tabpanel"
...
echo $response;
                                    ...
                                    <div class="tab-pane fade" id="p-media" role="tabpanel"
...
echo $response;
                                    ...
                                    <div class="tab-pane fade" id="p-tombol" role="tabpanel"
...
echo $response;
                                    ...
                                    <div class="tab-pane fade" id="webhooksss" role="tabpanel"
                                        aria-labelledby="pills-contact-tab">
                                        <br>
                                        <div class="example-container">
                                            <div class="example-code">
